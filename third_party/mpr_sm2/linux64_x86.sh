...
gcc -c -m64  -O3 mpr_sm2.c
gcc -c -m64  -O3 mpr_sm3.c
gcc -c -m64  -O3 sm4.c
...
ar r libmiracl.a mrbrick.o mrebrick.o mrec2m.o mrgf2m.o mrmuldv.o mrshs512.o
ar r libmiracl.a mrcomba.o
#ar r miracl.a mrcomba2.o
#ar r miracl.a mrkcm.o
ar r libmiracl.a mpr_sm2.o mpr_sm3.o sm4.o
